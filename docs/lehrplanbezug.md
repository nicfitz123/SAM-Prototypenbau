...
Der Pflichtgegenstand ist im Lehrplan mit folgendem Stundenausmass ausgewiesen:
...
als Kabelkonfektionierung, Anschluss elektronischer Betriebsmittel und Verdrahtung
...
Kompetenzorientiert bedeutet das:
- komplexe elektronische Schaltungen nach Schaltplan aufbauen und messtechnisch verifizieren
- Prototypen digitaler Systeme mit programmierbarer Logik entwerfen und testen
- strukturierte Netzwerke physikalisch aufbauen, pruefen und dokumentieren
- Schnittstellen zwischen Systemen (UART, SPI, I2C) analysieren und Fehler lokalisieren
- analoge und digitale Teilsysteme zu einem Gesamtsystem integrieren
...
- Kommunikationssysteme: HF-Technik, Netzwerkkonfiguration, Kommunikationssysteme 2

Kompetenzorientiert bedeutet das:
- Sensor-Aktor-Systeme mit Regelung aufbauen und parametrieren
- Embedded-Systeme unter Echtzeitbetriebssystem entwickeln und testen
- drahtlose Kommunikationssysteme aufbauen und messtechnisch erfassen
- leistungselektronische Schaltungen sicher dimensionieren, aufbauen und pruefen
- Projekte mit professionellen Methoden des Projektmanagements planen und abwickeln
